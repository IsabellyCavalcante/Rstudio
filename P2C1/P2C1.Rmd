...
Por fim uni todas as tabelas geradas acima para coloca-las em apenas uma tabela que será plotada. Para a visualização escolhi o gráfico violino que abaixo mostra a comparação da distribuição das porcentagem comparando homens e mulheres (no gráfico abaixo é para os meses e todos os anos).
```{r}
...
A partir dessa imagem podemos ver que comparando os homens no ano de 2015 para o de 2016 eles aparentam ter a mesma distribuição das porcentagens, ao contrário dos das mulheres que nota-se uma boa diferença nos trimestres de 2015 pro de 2016, com exceção do trimestre 1 que se parece bastante.
Outra informação que pode-se observar é que a distribuição das porcentagens femininas diminuem mais gradualmente que as masculinas que diminuem drasticamente. Por fim é possível afirmar também que as porcentagens mais altas tem concentração maior mais nas mulheres que nos homens, ou seja, as deputadas tem uma faixa de porcentagem de gastos com passagens para outras pessoas mais alta que os homens.